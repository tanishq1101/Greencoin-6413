  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <div className="rounded-2xl bg-moss/8 border border-moss/20 p-4">
        <label className="text-sm font-medium text-forest flex items-center gap-2 mb-2"><Wand2 size={16} /> Not sure of the type? Describe it</label>
        <div className="flex gap-2">
          <input value={aiText} onChange={(e) => setAiText(e.target.value)} placeholder="e.g. empty 1L Bisleri water bottle"
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <label className="block">
          ...
          <input value={brand} onChange={(e) => setBrand(e.target.value)} placeholder="Bisleri, Amul…"
        ...
        <label className="block">
          ...
          <input value={note} onChange={(e) => setNote(e.target.value)} placeholder="Where from…"
            className="w-full border border-border bg-card rounded-xl px-3.5 py-2.5 text-sm outline-none focus:border-moss" />
        </label>
      </div>
